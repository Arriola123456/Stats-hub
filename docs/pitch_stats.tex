...
\begin{frame}{Arquitectura}
  \vspace{0.15cm}
  \begin{center}
    \includegraphics[width=0.97\linewidth]{arquitectura.png}
  \end{center}
  \vspace{0.05cm}
  {\footnotesize\color{GrisSuave}Metadata e indicadores \textbf{pre-horneados} (offline) en
  \texttt{data/}; solo Descargas toca INEI en vivo. Desplegado en Streamlit Cloud desde GitHub.}
\end{frame}
